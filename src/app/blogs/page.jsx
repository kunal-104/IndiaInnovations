...
const blogsLink = Links.find(link => link.name === 'Innovations');
  return (
    <div className="flex flex-col md:flex-row h-screen bg-bodybg">
      ...
      /> : null  }
        ...
        <Breadcrumbs key='solid' variant='solid'>
          ...
          <BreadcrumbItem href={blogsLink.href} startContent={blogsLink && <blogsLink.icon className="blogs-icon" />}>Innovations</BreadcrumbItem>
        </Breadcrumbs>
