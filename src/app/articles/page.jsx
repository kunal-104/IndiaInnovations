...
const articlesLink = Links.find(link => link.name === 'Modern India');
  return (
    <div className="flex flex-col md:flex-row h-screen bg-bodybg">
      ...
      /> : null  }
        ...
        <Breadcrumbs key='solid' variant='solid'>
          ...
          <BreadcrumbItem href={articlesLink.href} startContent={articlesLink && <articlesLink.icon className="articles-icon" />}>Modern India</BreadcrumbItem>
        </Breadcrumbs>
